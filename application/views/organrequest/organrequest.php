...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Orgon |requesting page</title>
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"><img class="d-inline-block me-3" src="" alt="" ><h1>Orgon</h1></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link fw-bold active" aria-current="page" href="<?php echo SITE_PATH."/index.php/Organrequest";?>">Request organ</a></li>
              <li class="nav-item"><a class="nav-link" href="<?php echo SITE_PATH."/index.php/Profile";?>">Profile</a></li>
	 ...
	 <section class="py-0">
        <div class="bg-holder" style="background-image:url(<?=SITE_PATH?>/public/userassetes/public/assets/img/illustrations/dot.png);background-position:left;background-size:auto;margin-top:-105px;">
        </div>
        <!--/.bg-holder-->
        <div class="container position-relative">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-md-1 pt-8"><img class="img-fluid" src="<?=SITE_PATH?>/public/userassetes/public/assets/img/h2.jpg" alt="" /></div>
            <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
              <h1 class="mb-4 display-3 fw-bold">Request organ</h1>
              <p class="mt-3 mb-4 fs-1">fill recipient information for suitable organ</p><a class="btn btn-lg btn-primary rounded-pill hover-top" <a href ="<?=site_url();?>organrequest/insert" role="button">Fill form</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container-lg">
          ...
          <div class="row justify-content-center">
            <div class="col-sm-9 col-xl-8 text-center">
              <p>We provide to you the best choiches for you. Adjust it to your health needs and make sure your undergo transplant and treatment with our highly qualified doctors you can consult with us which type of service is suitable for your health after surgery</p>
            </div>
          </div>
